...
Note that webhook API objects are subject to the same [versioning compatibility rules](/docs/concepts/overview/Kubernetes-api/) as other PlaidCloud API objects.
