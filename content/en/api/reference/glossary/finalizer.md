...
short_description: >
  A namespaced key that tells PlaidCloud to wait until specific conditions are met
...
- operation
---
Finalizers are namespaced keys that tell PlaidCloud to wait until specific
...
When you tell PlaidCloud to delete an object that has finalizers specified for
it, the PlaidCloud API marks the object for deletion, putting it into a
...
PlaidCloud considers the deletion complete.
