...
In this example, the Stata file *Export Stata.dta* is imported from the *Analyze Demo Output* directory of PlaidCloud Document. The Analyze Target Table is *Import Stata*. 


Note that almost all of the columns are imported with a **Data Type** value of *String(256*. The modeler must manually change the **Data Type** value to numeric format, as needed. 
