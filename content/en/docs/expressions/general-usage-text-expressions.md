...
| func.bit\_length(stri ng) | int | Number of bits in string | bit_length(‘jose’) | 32 |
| func.char\_length(str ing) or func.character_length(string) | int | Number of characters in string | char\_leng th(‘jose’) | 4 |
...
| func.octet\_length(st ring) | int | Number of bytes in string | octet\_length(‘jose’ ) | 4 |
...
| func.substring(string frompatternforescape) | text | Extract substring matching SQL regular expression. | substring( ‘Thomas’ from ‘%#”o\_a#” \_’ for ‘#’) | oma |
