...
A *resource* is an endpoint in the [PlaidCloud API](/docs/concepts/overview/PlaidCloud-api/) that stores a collection of
...
The PlaidCloud [declarative API](/docs/concepts/overview/PlaidCloud-api/)
...
| You are willing to accept the format restriction that PlaidCloud puts on REST resource paths, such as API Groups and Namespaces. (See the [API Overview](/docs/concepts/overview/PlaidCloud-api/).) | You need to have specific REST paths to be compatible with an already defined REST API. |
