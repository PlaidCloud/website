...
<img src="/images/kubeadm-stacked-color.png" align="right" width="150px">Kubeadm is a tool built to provide `kubeadm init` and `kubeadm join` as best-practice "fast paths" for creating PlaidCloud clusters.

kubeadm performs the actions necessary to get a minimum viable cluster up and running. By design, it cares only about bootstrapping, not about provisioning machines. Likewise, installing various nice-to-have addons, like the PlaidCloud Dashboard, monitoring solutions, and cloud-specific addons, is not in scope.
...
* [kubeadm certs](/docs/reference/setup-tools/kubeadm/kubeadm-certs) to manage PlaidCloud certificates
