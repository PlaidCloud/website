  ...
  - **status.nonResourceRules** ([]NonResourceRule), required
    ...
    *NonResourceRule holds information that describes a rule for the non-resource*
    ...
    - **status.nonResourceRules.verbs** ([]string), required
      ...
      Verb is a list of PlaidCloud non-resource API verbs, like: get, post, put, delete, patch, head, options.  "*" means all.
  ...
  - **status.resourceRules** ([]ResourceRule), required
    ...
    *ResourceRule is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.*
    ...
    - **status.resourceRules.verbs** ([]string), required
      ...
      Verb is a list of PlaidCloud resource API verbs, like: get, list, watch, create, update, delete, proxy.  "*" means all.
