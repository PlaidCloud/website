...
short_description: >
  A lightweight container runtime specifically for PlaidCloud

aka:
tags:
- tool
---
A tool that lets you use OCI container runtimes with PlaidCloud CRI.
...
Deploying CRI-O allows PlaidCloud to use any OCI-compliant runtime as the container
