...
such as running a PlaidCloud cluster.

You can also find PlaidCloud as a managed service; sometimes called
Platform as a Service, or PaaS. With managed PlaidCloud, your
cloud provider is responsible for the PlaidCloud control plane as well
