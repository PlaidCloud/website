...
tool to easily install or uninstall Service Catalog on your PlaidCloud cluster, linking it to
...
* Service Catalog requires PlaidCloud version 1.7+.
* [Install and setup kubectl](/docs/tasks/tools/) so that it is configured to connect to a PlaidCloud v1.7+ cluster.
...
If you would like to uninstall Service Catalog from your PlaidCloud cluster using the `sc` tool, run:
